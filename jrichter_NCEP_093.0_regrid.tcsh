...
while($i < $FILES_MAX)
  ...
  setenv PRECISION           double       # "double" or "float" are the current choices of output precision
...
# Full input file pathnames (disk or HPSS) from which to pull fields to be regridded
  ...
  setenv FNAME1                 $SCRATCH/analyses_NCEP_094.0_CDAS/cdas1.${DATE2}.pgrbh.tar_file_dir/splanl.gdas.${DATE2}00.grb2
  setenv FNAME2                 $WORK/realtime/regrid_scripts/PHIS_0.9x1.25_cam3_6_71.nc
  setenv FNAME3                 none
  setenv FNAME4                 none
  setenv FNAME5                 none
...
# Time slice to pull from each file (YYYYMMDDSSSSS or time index (0, 1, 2, 3, etc.))
  setenv FDATE                  `cat date1`,`cat date1`,0
...
# Input analysis file index in which each field can be found (0, 1, 2, 3, 4, or 5)
  setenv SOURCE_FILES           0,0,0,0,0,0,1,1,2

# Input file type (The "FTYPE" list maps to the above list of filenames)
  setenv FTYPE                  NCEP_093.0_GDAS,NCEP_093.0_GDAS_sfc,CAM # was NCEP_094.0_CDAS for 2011-2020
